...
public final class CallCacheControlTest {
  ...
  @Test
  public void callWitCacheControlTest() throws IOException {
    final Request request = buildRequest(Service.class, CacheControl.FORCE_CACHE);
    assertThat(request.headers().get("Cache-Control"))
        .isEqualTo(CacheControl.FORCE_CACHE.toString());
  }

  @Test
  public void callOverrideMethodCacheControlTest() throws IOException {
    class Example {
