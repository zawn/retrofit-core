...
public abstract class HttpParamHandler {

  static final class RelativeUrl extends ParameterHandler<RequestBuilder, Object> {
  ...
  static final class Header<T> extends ParameterHandler<RequestBuilder, T> {
  ...
  static final class Path<T> extends ParameterHandler<RequestBuilder, T> {
    private final Method method;
    private final int p;
    private final String name;
    private final Converter<T, String> valueConverter;
  ...
  static final class Query<T> extends ParameterHandler<RequestBuilder, T> {
    private final String name;
    private final Converter<T, String> valueConverter;
    private final boolean encoded;
  ...
  static final class QueryName<T> extends ParameterHandler<RequestBuilder, T> {
  ...
  static final class QueryMap<T> extends ParameterHandler<RequestBuilder, Map<String, T>> {
    private final Method method;
    private final int p;
    private final Converter<T, String> valueConverter;
    private final boolean encoded;
  ...
  static final class HeaderMap<T> extends ParameterHandler<RequestBuilder, Map<String, T>> {
    private final Method method;
    private final int p;
    private final Converter<T, String> valueConverter;
  ...
  static final class Headers extends ParameterHandler<RequestBuilder, okhttp3.Headers> {
    private final Method method;
    private final int p;
  ...
  static final class Field<T> extends ParameterHandler<RequestBuilder, T> {
    private final String name;
    private final Converter<T, String> valueConverter;
    private final boolean encoded;
  ...
  static final class FieldMap<T> extends ParameterHandler<RequestBuilder, Map<String, T>> {
    private final Method method;
    private final int p;
    private final Converter<T, String> valueConverter;
    private final boolean encoded;
  ...
  static final class Part<T> extends ParameterHandler<RequestBuilder, T> {
    private final Method method;
    private final int p;
  ...
  static final class RawPart extends ParameterHandler<RequestBuilder, MultipartBody.Part> {
  ...
  static final class PartMap<T> extends ParameterHandler<RequestBuilder, Map<String, T>> {
    private final Method method;
    private final int p;
  ...
  static final class Body<T> extends ParameterHandler<RequestBuilder, T> {
    private final Method method;
    private final int p;
    private final Converter<T, RequestBody> converter;
  ...
  static final class Tag<T> extends ParameterHandler<RequestBuilder, T> {
    final Class<T> cls;
