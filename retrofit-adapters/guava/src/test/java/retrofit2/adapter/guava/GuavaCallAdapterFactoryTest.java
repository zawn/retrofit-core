...
public final class GuavaCallAdapterFactoryTest {
  ...
  @Test public void responseType() {
    ...
    Type responseClass = new TypeToken<ListenableFuture<ResponseWrapper<String>>>() {}.getType();
    assertThat(factory.get(responseClass, NO_ANNOTATIONS, retrofit).responseType())
        .isEqualTo(String.class);
    Type responseWildcard = new TypeToken<ListenableFuture<ResponseWrapper<? extends String>>>() {}.getType();
    assertThat(factory.get(responseWildcard, NO_ANNOTATIONS, retrofit).responseType())
        .isEqualTo(String.class);
    Type resultClass = new TypeToken<ListenableFuture<ResponseWrapper<String>>>() {}.getType();
    assertThat(factory.get(resultClass, NO_ANNOTATIONS, retrofit).responseType())
        .isEqualTo(String.class);
    Type resultWildcard = new TypeToken<ListenableFuture<ResponseWrapper<? extends String>>>() {}.getType();
  ...
  @Test public void rawResponseTypeThrows() {
    Type observableType = new TypeToken<ListenableFuture<ResponseWrapper>>() {}.getType();
    try {
      factory.get(observableType, NO_ANNOTATIONS, retrofit);
      fail();
    } catch (IllegalStateException e) {
