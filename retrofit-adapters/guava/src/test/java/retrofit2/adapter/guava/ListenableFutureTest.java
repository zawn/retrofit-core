...
public final class ListenableFutureTest {
  ...
  interface Service {
    ...
    @GET("/") ListenableFuture<ResponseWrapper<String>> response();
  }
  ...
  @Test public void bodySuccess404() throws Exception {
    ...
    try {
      ...
      assertThat(e.getCause())
          ...
          .isInstanceOf(retrofit2.okhttp.HttpException.class)
  ...
  @Test public void responseSuccess200() throws Exception {
    ...
    ListenableFuture<ResponseWrapper<String>> future = service.response();
